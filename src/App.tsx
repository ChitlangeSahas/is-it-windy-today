...
export default function App() {
    ...
    const getForcastData = () => {
        axios.get("https://api.weather.gov/gridpoints/LWX/89,70/forecast/hourly").then(response => {
            ...
            <Box sx={{display: 'flex',flexDirection: 'column', alignItems: 'center', alignContent: 'center', height: '100vh'}}>
                <div className={"container"}>
                    ...
                    <div className="forward-button">
                        <IconButton onClick={incrementHour} variant={"solid"}><ArrowForwardIcon/></IconButton>
                    </div>
                </div>
            </Box>
        </CssVarsProvider>
